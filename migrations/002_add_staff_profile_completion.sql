...
-- PREREQUISITE: Run 001_add_pending_to_employment_status.sql FIRST!
-- ============================================================================

BEGIN;

-- 1. Add profile_completed flag
ALTER TABLE public.bus_staff 
ADD COLUMN IF NOT EXISTS profile_completed BOOLEAN DEFAULT FALSE;

-- 2. Make bus_owner_id optional (can be assigned later by admin)
ALTER TABLE public.bus_staff 
ALTER COLUMN bus_owner_id DROP NOT NULL;

-- 3. Make hire_date optional (set when approved)
ALTER TABLE public.bus_staff 
ALTER COLUMN hire_date DROP NOT NULL;

-- 4. Update default employment status to pending (NOW this will work!)
ALTER TABLE public.bus_staff 
